...
import type { TaskPendingToolCall } from "@cocapn/agent";
import { formatTokens, toRelativePath } from "@cocapn/shared";
import type { ToolRenderState } from "@cocapn/shared/lib/tool-state";
import {
  Bot,
  FileText,
  FilePlus,
